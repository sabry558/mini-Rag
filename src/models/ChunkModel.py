...
class ChunkModel(BaseDataModel):
    ...
    def __init__(self, db_client:object):
        ...
        self.collection = self.db_client.get_collection(DataBaseEnum.CHUNKS.value)

    async def create_chunks(self, chunks:DataChunk):
        result = await self.collection.insert_one(chunks.dict(by_alias=True, exclude_unset=True))
